...
#
# Usage:
#   RESOURCE_GROUP=f1-fantazy-bot ACI_NAME=f1-fantasy-live-score-aci \
#     bash scripts/grant-runner-msi.sh

set -euo pipefail

RESOURCE_GROUP="${RESOURCE_GROUP:-f1-fantazy-bot}"
ACI_NAME="${ACI_NAME:-f1-fantasy-live-score-aci}"
LOGIC_APP_NAME="${LOGIC_APP_NAME:-f1-fantasy-live-score-scheduler}"
